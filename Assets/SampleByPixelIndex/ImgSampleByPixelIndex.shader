...
Shader "Wunder/ImgSampleByPixelIndex"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float3 _GPUSkinning_TextureSize_NumPixelsPerFrame;//(width,height,NumPixelsPerFrame)
            ...
            v2f vert(appdata_t v)
            {
	            ...
	            float4 targetPixelColor = tex2Dlod(_MainTex, indexToUV(_Index));
	            //float4 targetPixelColor = tex2Dlod(_MainTex, float4(0,0,0,0));

                //OUT.color = v.color * _Color;
                OUT.color = targetPixelColor;
                return OUT;
            }
